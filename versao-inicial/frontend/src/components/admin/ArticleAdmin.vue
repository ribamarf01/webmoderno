<template>
    <div class="article-admin">
        <b-form>
            <input type="hidden" id='article-id' v-model='article.id'>
				<b-form-group label='Nome:' label-for='article-name'>
					<b-form-input 
						id='article-name' type='text' v-model='article.name' 
						required :readonly='mode === "remove"' placeholder="Informe o nome do artigo..."
					/>
				</b-form-group>
				<b-form-group label='Descrição:' label-for='article-description'>
					<b-form-input 
						id='article-description' type='text' v-model='article.description' 
						required :readonly='mode === "remove"' placeholder="Informe a descrição do artigo..."
					/>
				</b-form-group>
				<b-form-group label='Imagem (URL):' label-for='article-image'>
					<b-form-input 
						id='article-image' type='text' v-model='article.imageUrl' 
        ...
        <hr>
        <b-table class='mt-3' hover striped :items='articles' :fields='fields'>
