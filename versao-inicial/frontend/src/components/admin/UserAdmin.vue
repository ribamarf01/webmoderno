            ...
            <b-row>
                <b-col md='6' sm='12'>
                    <b-form-group label='Nome:' label-for='user-name'>
                        <b-form-input 
                            id='user-name' type='text' v-model='user.name' 
                ...
                <b-col md='6' sm='12'>
                    <b-form-group label='E-mail:' label-for='user-email'>
                        <b-form-input 
                            id='user-email' type='text' v-model='user.email' 
                            required :readonly='mode === "remove"' placeholder="Informe o e-mail do usuário..."
                        />
                    </b-form-group>
                </b-col>
            </b-row>
            ...
            <b-row v-show="mode === 'save'">
                <b-col md='6' sm='12'>
                    <b-form-group label='Senha:' label-for='user-password'>
                        <b-form-input 
                            id='user-password' type='password' v-model='user.password' 
                            required placeholder="Informe a senha do usuário..."
                        />
                    </b-form-group>
                </b-col>
                <b-col md='6' sm='12'>
                    <b-form-group label='Confirmar a senha:' label-for='user-confirmPassword'>
                        <b-form-input 
                            id='user-confirmPassword' type='password' v-model='user.confirmPassword' 
